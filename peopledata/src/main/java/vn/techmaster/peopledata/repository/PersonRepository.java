...
public class PersonRepository {
    ...
    */
    ...
    //Tìm ra thành phố có độ tuổi trung bình của lập trình viên trẻ nhất
    ...
    public Map<String, List<Person>> devHanoiSaigonShanghai() {
        return people
                .stream()
                .filter(p -> p.getJob().equals("developer"))
    ...
    //Liệt kê tỷ lệ nam/nữ ở từng thành phố
